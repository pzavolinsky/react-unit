...
var UnitComponent = (function () {
    function UnitComponent(comp, parent) {
        this.nodeType = 1;
        ...
        if (!parent) {
            this.root = new UnitComponent({}, ROOT);
    ...
    UnitComponent.prototype.findByComponent = function (componentClass) {
        return this.findBy(function (e) { return e.componentInstance &&
            react_addons_test_utils_1.isElementOfType(e.componentInstance, componentClass); });
    };
